...
-- MPD
local musicplr = awful.util.terminal .. " -title Music -g 13x34-32+16 -e ncmpcpp"
...
--  UNCOMMENT THE FOLLOWING FOR GETTING DESCRIPTION FOR THE WINDOWS

    -- Create a tasklist widget
    --s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons)

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(16), bg = theme.bg_normal, fg = theme.fg_normal, visible = false })
	...
	spotify_widget({
	    ...
	    show_tooltip = false
            ...
            --wibox.container.background(wibox.container.margin(wibox.widget { nil, theme.spotify and theme.spotify.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#343434"),
            ...
            arrow("#8DAA9A", "#78909C"),--"#C0C0A2"
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#78909C"),
            arrow("#78909C", "#777E76"),
