...
awful.util.tagnames = { "Web", "Code", "Term", "Music", "Misc1", "Misc2", "Misc3" }
awful.layout.layouts = {
    awful.layout.suit.tile, --for web tab
    awful.layout.suit.tile, --for code tab
    awful.layout.suit.tile, --for term tab
    awful.layout.suit.tile, --for music tab
    awful.layout.suit.tile, --for misc1 tab
    awful.layout.suit.tile, --for misc2 tab
    awful.layout.suit.floating, --for misc3 tab
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher", tag = "term"}),
